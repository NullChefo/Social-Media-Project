...
public class PopulateDefaultsUtil {
	...
	public void PopulateDefaults() {
		...
		RegisteredClient registeredClient = RegisteredClient.withId(
															...
															.redirectUri(
																	"https://social-media-project.nullchefo.com/auth/authorized")
															.redirectUri("https://social-media-project.nullchefo.com")
															.redirectUri(
																	"https://social-media-project.nullchefo.com/silent-renew.html")
															...
															.redirectUri(
																	"https://ui-social-media-project-java-railway.nullchefo.com/silent-renew.html")
															.redirectUri(
